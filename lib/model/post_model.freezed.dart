...
mixin _$BooksModel {
 ...
 String get userID; String get type; String get category; String get grade; String get location; String get description; String get board; List<String> get subjects; String get imageUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userID,type,category,grade,location,description,board,const DeepCollectionEquality().hash(subjects),imageUrl);

@override
String toString() {
  return 'BooksModel(userID: $userID, type: $type, category: $category, grade: $grade, location: $location, description: $description, board: $board, subjects: $subjects, imageUrl: $imageUrl)';
}
...
@useResult
$Res call({
 String userID, String type, String category, String grade, String location, String description, String board, List<String> subjects, String imageUrl
});
...
/// Create a copy of BooksModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userID = null,Object? type = null,Object? category = null,Object? grade = null,Object? location = null,Object? description = null,Object? board = null,Object? subjects = null,Object? imageUrl = null,}) {
...
class _BooksModel implements BooksModel {
  const _BooksModel({required this.userID, required this.type, required this.category, required this.grade, required this.location, required this.description, required this.board, required final  List<String> subjects, required this.imageUrl}): _subjects = subjects;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userID,type,category,grade,location,description,board,const DeepCollectionEquality().hash(_subjects),imageUrl);
...
/// Create a copy of BooksModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userID = null,Object? type = null,Object? category = null,Object? grade = null,Object? location = null,Object? description = null,Object? board = null,Object? subjects = null,Object? imageUrl = null,}) {
...
mixin _$ClothesModel {
 ...
 String get userID; String get type; String get size; String get description; String get location; String get category; String get imageUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userID,type,size,description,location,category,imageUrl);

@override
String toString() {
  return 'ClothesModel(userID: $userID, type: $type, size: $size, description: $description, location: $location, category: $category, imageUrl: $imageUrl)';
}
...
@useResult
$Res call({
 String userID, String type, String size, String description, String location, String category, String imageUrl
});
...
/// Create a copy of ClothesModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userID = null,Object? type = null,Object? size = null,Object? description = null,Object? location = null,Object? category = null,Object? imageUrl = null,}) {
  return _then(_self.copyWith(
userID: null == userID ? _self.userID : userID // ignore: cast_nullable_to_non_nullable
as String,type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
...
class _ClothesModel implements ClothesModel {
  const _ClothesModel({required this.userID, required this.type, required this.size, required this.description, required this.location, required this.category, required this.imageUrl});
...
/// Create a copy of ClothesModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userID = null,Object? type = null,Object? size = null,Object? description = null,Object? location = null,Object? category = null,Object? imageUrl = null,}) {
