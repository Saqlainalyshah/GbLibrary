package com.example.booksexchange // Use your correct package name
...
class MainActivity : FlutterActivity() {
    ...
    private val NATIVE_AD_ID = "nativeAd"
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        GoogleMobileAdsPlugin.registerNativeAdFactory(flutterEngine, NATIVE_AD_ID, factory)
        ...
        // TensorFlow Lite inference channel
    ...
    override fun cleanUpFlutterEngine(flutterEngine: FlutterEngine) {
        GoogleMobileAdsPlugin.unregisterNativeAdFactory(flutterEngine, NATIVE_AD_ID)
    }
